...
public class AvailabilitySeeder {
    ...
    public void seed() {
        ...
        availabilityDAO.createAvailability(elements.get(3), java.time.LocalDateTime.of(2024, 3, 9, 12, 12), java.time.LocalDateTime.of(2024, 4, 9, 12, 12), ChronoUnit.DAYS, 0);
        availabilityDAO.createAvailability(elements.get(4), java.time.LocalDateTime.of(2024, 4, 8, 12, 12), java.time.LocalDateTime.of(2024, 5, 8, 12, 12), ChronoUnit.DAYS, 0);
        availabilityDAO.createAvailability(elements.get(5), java.time.LocalDateTime.of(2024, 5, 7, 12, 12), java.time.LocalDateTime.of(2024, 6, 7, 12, 12), ChronoUnit.DAYS, 0);
