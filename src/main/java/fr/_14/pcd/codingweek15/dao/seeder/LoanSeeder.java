...
public class LoanSeeder {
    ...
    public void seed() {
        ...
        loanDAO.createLoan(new Date(2024, 12, 12), new Date(2024, 12, 12), elements.get(0), users.get(1));
        loanDAO.createLoan(new Date(2024, 1, 11), new Date(2024, 1, 11), elements.get(1), users.get(2));
        loanDAO.createLoan(new Date(2024, 2, 10), new Date(2024, 2, 10), elements.get(2), users.get(0));
        loanDAO.createLoan(new Date(2024, 3, 9), new Date(2024, 4, 9), elements.get(3), users.get(2));
        loanDAO.createLoan(new Date(2024, 4, 8), new Date(2024, 5, 8), elements.get(4), users.get(0));
